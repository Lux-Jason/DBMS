...
<style>
    ...
    .add_item_admin-container input[type="file"], 
...
<div class="main-container">
    <div class="add_item_admin-container">
        ...
        <form action="additem_sql_op.php" method="post" enctype="multipart/form-data">
            ...
            <input type="number" name="selling_price" placeholder="Input the selling-to-us price" id="selling_price" onfocus="inputFocus(this)" required>
            <input type="number" name="buying_price" placeholder="Input the buying-from-us price" id="buying_price" onfocus="inputFocus(this)" required>
            <input type="file" name="image_path" placeholder="Input Image Path" id="image_path" onfocus="inputfocus(this)" value="./image/" required>
            <button type="submit" name="submit">Add</button>
        </form>
        <p>Back to <a href="Admin_pg.php" class="links">Administrator Page</a></p>
