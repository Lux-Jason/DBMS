...
?>
    ...
    <header>
        <div class="logo-container">
            ...
            <a href="sellers_page.php" class="button" style="color: #007bff; border: #007bff 1px solid; background-color: white;">Sellers Interface</a>
        </div>
        <div>
        <?php
            session_start();
            ...
            if (isset($_SESSION['username'])) {
                ...
                echo '<a href="logout_sellers.php" class="button">Logout</a>';
            } else {
    ...
    <div class="products-container">
        ...
        <?php include "showitems_sellers.php"; ?>
    </div>
